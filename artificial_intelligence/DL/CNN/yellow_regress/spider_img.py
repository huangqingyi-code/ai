...
import re
import os
lst = ["厦大","哈佛","香港","重庆","厦门","成都","福州"]
for i in lst:


    path = f"D:\dataset\yellow_minion\{i}"
    ...
    url = "https://image.baidu.com/search/acjson?tn=resultjson_com&ipn=rj&ct=201326592&is=&fp=result&queryWord=" \
          "{word}&cl=2&lm=-1&ie=utf-8&oe=utf-8&adpicid=&st=-1&z=&ic=0&word={word}&s=&se=&tab=&width=&height=&face=" \
          "0&istype=2&qc=&nc=1&fr=&cg=girl&pn={pageNum}&rn=30&gsm=1e00000000001e&1490169411926="
    ...
    while (n<3000):
        ...
        #打开网页
        rep = urllib.request.urlopen(rep)  #timeout相应延迟
        #获取网页内容
        try:
